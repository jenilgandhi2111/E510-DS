...
class ReducerWorker:
    ...
    def sendPulseToMaster(self):
        time.sleep(0.1)
        print(
            f"> Reducer{self.identifier}: Pulse started from reducer:", self.identifier
        )
        while True:
    ...
    def startReducing(self):
        ...
        try:
            ...
            print(f"> Reducer {self.identifier}: has completed reducing task!")
    ...
    def handleMessage(self, messageStr: str):
        ...
        if "_Done_" in messageStr:
            ...
            print(f"> Reducer{self.identifier}: is killed")
    ...
    def listenRequests(self):
        ...
        print(f"> Reducer{self.identifier}: is listening on {self.host}:{self.port}")
        while True:
    ...
    def __init__(self, identifier, reducingFunctionLocation, testcase, numMappers):
        self.state = 0
